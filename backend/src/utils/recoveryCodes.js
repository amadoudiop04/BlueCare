 ...
 *
 * Un telephone perdu ne doit pas enfermer une infirmiere dehors un dimanche.
 * Ces codes sont montres une seule fois, a l activation, puis seuls leurs
 * hachages sont conserves — comme un mot de passe. Chacun ne sert qu une fois.
 */

const COUNT = 8
const GROUP = 4

/** `A3F2-9K1D` : lisible a voix haute, sans caracteres ambigus (0/O, 1/I). */
 ...
 * Le cout bcrypt est volontairement plus faible que pour un mot de passe : ces
 * codes font 40 bits d'entropie chacun et sont a usage unique.
 */
 ...
 * Rend la liste amputee du code consomme, ou `null` si aucun ne correspond.
 */
